...
namespace BOS.StarterCode.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public IMultitenantService _multitenantService;
        ...
        {
            string status = "";
            if (HttpContext != null && HttpContext.Session != null && HttpContext.Session.GetObject<List<Module>>("ModuleOperations") == null)
            {
                try
                {
                    if (UserId != null && UserId!= Guid.Empty)
                    {
                        ...
                        if (enabledBOSapis != null)
                        {
                            if (enabledBOSapis.Contains("IA"))
                            {
                                ...
                                if (permissionSet != null && permissionSet.StatusCode == System.Net.HttpStatusCode.Unauthorized)
                                {
                                ...
                                if (permissionSet.IsSuccessStatusCode)
                                {
                                    ...
                                    {
                                        HttpContext.Session.SetObject("ModuleOperations", permissionSet.Permissions.Components.FirstOrDefault(x => x.Code == "DFLTS").ChildComponents); //On success, saving it in the Session Object
                                    }
                                }
                            }
                            else
